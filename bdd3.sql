...
-- Listage de la structure de la base pour filesranks
DROP DATABASE IF EXISTS `filesranks`;
CREATE DATABASE IF NOT EXISTS `filesranks` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `filesranks`;

-- Listage de la structure de la table filesranks. appartient_mot-cle
DROP TABLE IF EXISTS `appartient_mot-cle`;
...
-- Listage des données de la table filesranks.appartient_mot-cle : ~2 rows (environ)
/*!40000 ALTER TABLE `appartient_mot-cle` DISABLE KEYS */;
INSERT INTO `appartient_mot-cle` (`id`, `id_doc`, `id_keyword`) VALUES
	(1, 1, 1);
...
CREATE TABLE IF NOT EXISTS `document` (
  ...
  `NomDoc` varchar(30) NOT NULL DEFAULT '0',
  `TypeDoc` varchar(15) NOT NULL DEFAULT '0',
  `DescriptionDoc` varchar(50) NOT NULL DEFAULT '0',
...
-- Listage des données de la table filesranks.document : ~2 rows (environ)
...
-- Listage des données de la table filesranks.mot-cle : ~2 rows (environ)
...
DROP TABLE IF EXISTS `parametrevolume`;
...
-- Listage des données de la table filesranks.theme : ~4 rows (environ)
